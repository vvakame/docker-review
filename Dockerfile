...
RUN mkdir -p /usr/share/texlive/texmf-dist/fonts/map/dvipdfmx/ptex-fontmaps && \
    cd /usr/share/texlive/texmf-dist/fonts/map/dvipdfmx/ptex-fontmaps && \
    tar zxvf /tmp/noto-map.tgz && rm /tmp/noto-map.tgz
